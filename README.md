...
This scripts converts `.txt` file, that could be exported from Pro Tools using *Export Session Info as Text* command, into `.html` or `.csv` file. HTML file is ready to print, and CSV could be easily edited in Numbers.app or Excel. Also an macOS app with drag-n-drop support is provided.
#### Usage
```
